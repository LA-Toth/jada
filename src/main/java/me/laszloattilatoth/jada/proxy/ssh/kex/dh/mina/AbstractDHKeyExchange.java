/*
 * Modifications of mina-sshd's org.apache.sshd.common.kex.dh.AbstractDHKeyExchange:
...
package me.laszloattilatoth.jada.proxy.ssh.kex.dh.mina;

import me.laszloattilatoth.jada.proxy.ssh.kex.KeyExchange;
import me.laszloattilatoth.jada.proxy.ssh.kex.WithKeyExchange;
...
import static org.apache.sshd.common.kex.KeyExchange.isValidDHValue;

public abstract class AbstractDHKeyExchange extends WithKeyExchange {
    protected byte[] v_s;
    protected byte[] v_c;
    protected byte[] i_s;
    protected byte[] i_c;
    ...
    public AbstractDHKeyExchange(KeyExchange keyExchange) {
        super(keyExchange);
    }
    ...
    protected void validateEValue(BigInteger pValue) throws Exception {
        ...
        if (!isValidDHValue(value, pValue)) {
